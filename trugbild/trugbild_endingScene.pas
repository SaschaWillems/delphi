...
uses
  ...
  Trugbild_Global, TrugBild_GameClass, TrugBild_DecisionClass, TrugBild_PlayerClass;
...
//      if (MousePos.y > ClientHeight / 2 - 200) and (MousePos.y < ClientHeight / 2 + 200) then
//      	begin
...
//	glDepthMask(False);
  ...
  if Player.Bias >= 0 then
      ...
      TextureManager.SetBlending(bmBlend);
      glBegin(GL_QUADS);
        glColor4f(0.15, 0.15, 0.15, 1); glVertex3f(0,         0,   1);
        glColor4f(0.15, 0.15, 0.15, 1); glVertex3f(FBO.Width, 0,   1);
        glColor4f(0.15, 0.15, 0.15, 0); glVertex3f(FBO.Width, FBO.Height*0.65, 1);
        glColor4f(0.15, 0.15, 0.15, 0); glVertex3f(0,         FBO.Height*0.65, 1);
      glEnd;
      glColor3f(1, 1, 1);
    end
  else
      ...
      glPushMatrix;
        ...
        TextureManager.SetBlending(bmBlend);
        glBegin(GL_QUADS);
          glColor4fv(@PlaneColS); glVertex3f(0,         FBO.Height,      1);
          glColor4fv(@PlaneColS); glVertex3f(FBO.Width, FBO.Height,      1);
          glColor4fv(@PlaneColE); glVertex3f(FBO.Width, FBO.Height*0.65, 1);
          glColor4fv(@PlaneColE); glVertex3f(0,         FBO.Height*0.65, 1);
        glEnd;
        glBegin(GL_QUADS);
          glColor4fv(@PlaneColS); glVertex3f(0,         0,               1);
          glColor4fv(@PlaneColS); glVertex3f(FBO.Width, 0,               1);
          glColor4fv(@PlaneColE); glVertex3f(FBO.Width, FBO.Height*0.35, 1);
          glColor4fv(@PlaneColE); glVertex3f(0,         FBO.Height*0.35, 1);
        glEnd;
        glColor3f(1, 1, 1);
      glPopMatrix;
    end;
