...
uses
  ...
  Trugbild_Global, TrugBild_GameClass;
...
begin
  ...
  Person[Right].Texture := XMLNode.Attributes['right'];
	...
	if SameText(XMLNode.ChildNodes[CurrentLine].Attributes['position'], 'left') then begin
	...
	if SameText(XMLNode.ChildNodes[CurrentLine].Attributes['position'], 'right') then begin
